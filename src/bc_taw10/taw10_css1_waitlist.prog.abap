...
ENDCLASS.                    "cl_taw10_customer DEFINITION
...
ENDCLASS.                    "cl_taw10_customer IMPLEMENTATION
...
CLASS cl_taw10_waitlist DEFINITION.
  PUBLIC SECTION.
    ...
    TYPES itt_wait_list
            TYPE STANDARD TABLE OF REF TO cl_taw10_customer WITH DEFAULT
            KEY.
    ...
    METHODS add IMPORTING im_customer TYPE REF TO cl_taw10_customer
                RAISING   cx_taw10_cust_in_list.

    METHODS delete IMPORTING im_customer TYPE REF TO cl_taw10_customer
                   RAISING   cx_taw10_cust_not_in_list.

    METHODS get_pos IMPORTING im_customer TYPE REF TO cl_taw10_customer
...
ENDCLASS.                    "cl_taw10_waitlist DEFINITION
...
ENDCLASS.                    "cl_taw10_waitlist IMPLEMENTATION
...
ENDCLASS.                    "cl_taw10_display_log DEFINITION
...
ENDCLASS.                    "cl_taw10_display_log IMPLEMENTATION
...
*
*---------------------------------------------------------------------*
CLASS cl_taw10_log DEFINITION INHERITING FROM cl_taw10_display_log.
  PUBLIC SECTION.
    METHODS get_cust FOR EVENT first_got OF cl_taw10_waitlist
                            IMPORTING ex_cust.

    INTERFACES if_taw10_status.

ENDCLASS.                    "cl_taw10_log DEFINITION
...
ENDCLASS.                    "cl_taw10_log IMPLEMENTATION
