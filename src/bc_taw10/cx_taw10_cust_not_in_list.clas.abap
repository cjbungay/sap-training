class CX_TAW10_CUST_NOT_IN_LIST definition
  public
  inheriting from CX_STATIC_CHECK
  final
  create public .

*"* public components of class CX_TAW10_CUST_NOT_IN_LIST
*"* do not include other source files here!!!
public section.

  constants CX_TAW10_CUST_NOT_IN_LIST type SOTR_CONC
 value '0AAA9D3DC2AB2225E10000000A114627'. "#EC NOTEXT
...
CLASS CX_TAW10_CUST_NOT_IN_LIST IMPLEMENTATION.
...
.
 IF textid IS INITIAL.
   me->textid = CX_TAW10_CUST_NOT_IN_LIST .
 ENDIF.
