*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_SPARTNER
*   generation date: 15.10.1999 at 16:49:06 by user LECHNERI
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_SPARTNER            .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_SPARTNER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = SPARTNER_EXTRACT
TOTAL = SPARTNER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_SPARTNER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_SPARTNER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = SPARTNER_EXTRACT
TOTAL = SPARTNER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_SPARTNER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_SPARTNER'
...
TOTAL = SPARTNER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_SPARTNER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_SPARTNER-UPD_FLAG NE SPACE.
