...
MODULE user_command_0100 INPUT.
  ...
  CASE ok_code.
    ...
    WHEN 'CREATE'.
      READ TABLE buffer_list INTO r_waitlist WITH KEY
      ...
      IF sy-subrc <> 0.
        ...
        INSERT r_waitlist INTO TABLE buffer_list.
        MESSAGE s905(bc401) WITH sdyn_conn-carrid sdyn_conn-connid
        sdyn_conn-fldate.
...
*       Keine Warteliste zum Flug &1 &2 &3 vorhanden!
    ...
    WHEN 'DELETE'.
      ...
      IF sy-subrc = 0.
        MESSAGE s906(bc401) WITH sdyn_conn-carrid sdyn_conn-connid
        sdyn_conn-fldate.
...
*           Kunde &1 in die Warteliste zum Flug &2 &3 &4 aufgenommen
          ...
          CATCH cx_bc401_cust_in_list INTO r_exc.
            text = r_exc->get_text( ).
            MESSAGE text TYPE 'I'.
        ENDTRY.
...
*          Kunde &1 wurde von der Warteliste zum Flug &2 &3 &4 gelöscht!
          ...
          CATCH cx_bc401_cust_not_in_list INTO r_exc.
            text = r_exc->get_text( ).
            MESSAGE text TYPE 'I'.
        ENDTRY.
