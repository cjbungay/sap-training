class CX_BC401_EMPTY_LIST definition
  public
  inheriting from CX_STATIC_CHECK
  final
  create public .

*"* public components of class CX_BC401_EMPTY_LIST
*"* do not include other source files here!!!
public section.

  constants CX_BC401_EMPTY_LIST type SOTR_CONC value '4DAA9D3DC2AB2225E10000000A114627'. "#EC NOTEXT
...
CLASS CX_BC401_EMPTY_LIST IMPLEMENTATION.
