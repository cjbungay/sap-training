...
*&                                                                     *
*&---------------------------------------------------------------------*
*&  create itab-type with RTTC techniques !                            *
*&  instantiate itab -> dynamic programing --> data browser            *
*&---------------------------------------------------------------------*

REPORT sapbc401_dynt_rtts_2.
...
*** create itab directly without type creation *******
  CREATE DATA ref_itab TYPE STANDARD TABLE OF (pa_tab)
                       WITH NON-UNIQUE DEFAULT KEY.

** now create itab with RTTC technique !
**
**  delete the old technique obove and
