*&---------------------------------------------------------------------*
*& Report  SAPBC402_TABD_COMPARE_READ_KEY                              *
*&                                                                     *
*&---------------------------------------------------------------------*
...
*   standard
    ...
    READ TABLE p_it_st   TRANSPORTING NO FIELDS
...
*   sorted with unique key
    GET RUN TIME FIELD rt_start.       " <-- start
    READ TABLE p_it_so_u  TRANSPORTING NO FIELDS
      WITH TABLE KEY carrid = c_carrid
                     connid = c_connid
                     fldate = c_fldate
                     bookid = c_bookid.
...
*   sorted with non-unique key
    GET RUN TIME FIELD rt_start.       " <-- start
    READ TABLE p_it_so_n  TRANSPORTING NO FIELDS
      WITH TABLE KEY carrid = c_carrid
                     connid = c_connid
                     fldate = c_fldate
                     bookid = c_bookid.
...
*   hashed
    GET RUN TIME FIELD rt_start.       " <-- start
    READ TABLE p_it_hs    TRANSPORTING NO FIELDS
      WITH TABLE KEY carrid = c_carrid
                     connid = c_connid
                     fldate = c_fldate
                     bookid = c_bookid.
