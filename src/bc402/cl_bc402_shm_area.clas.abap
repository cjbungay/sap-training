class CL_BC402_SHM_AREA definition
  public
...
*"* public components of class CL_BC402_SHM_AREA
*"* do not include other source files here!!!
public section.

  constants AREA_NAME type SHM_AREA_NAME value 'CL_BC402_SHM_AREA'. "#EC NOTEXT
  data ROOT type ref to CL_BC402_SHM_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to CL_BC402_SHM_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to CL_BC402_SHM_ROOT
    raising
  ...
  methods GET_ROOT
    redefinition .
protected section.
*"* protected components of class CL_BC402_SHM_AREA
*"* do not include other source files here!!!
private section.
*"* private components of class CL_BC402_SHM_AREA
*"* do not include other source files here!!!
...
CLASS CL_BC402_SHM_AREA IMPLEMENTATION.
