*&---------------------------------------------------------------------*
*& Report  SAPBC402_TABD_TABLE_PROPS_1                                 *
*&                                                                     *
*&---------------------------------------------------------------------*
*& BC402 demonstration                                                 *
*& Scenario:                                                           *
...
*&                                                                     *
*&   ----------------------------------------------------------------- *
*&   The current demo is the program displaying STEP 1.                *
*&   ----------------------------------------------------------------- *
*&   A HASHED table with UNIQUE key is used for IT_RESULT.             *
*&   So the elimination of duplictes is not necessary any more.        *
*&                                                                     *
*&   A STANDARD table is used for IT_CONNECTIONS.                      *
*&   To optimize the inner LOOP over IT_CONNECTIONS:                   *
