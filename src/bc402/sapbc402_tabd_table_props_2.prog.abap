*&---------------------------------------------------------------------*
*& Report  SAPBC402_TABD_TABLE_PROPS_2                                 *
*&                                                                     *
*&---------------------------------------------------------------------*
*& BC402 demonstration                                                 *
*& Scenario:                                                           *
...
*&                                                                     *
*&   ----------------------------------------------------------------- *
*&   The current demo is the program displaying STEP 2.                *
*&   ----------------------------------------------------------------- *
...
*   of first connection
    LOOP AT it_connection INTO wa2_connection
...
*    cityto   TYPE s_city,              " city of destination
*    carrid   TYPE s_carr_id,           " carrier id of 1st connection
*    connid   TYPE s_conn_id,           " connection id of 1st
*connection
*    carrid2  TYPE s_carr_id,           " carrier id of 2nd connection
*    connid2  TYPE s_conn_id,           " connection id of 2nd
*connection
*  END OF result,
*
** table types
