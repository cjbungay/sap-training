...
************************************************************************
  METHOD on_context_menu_request.
    ...
    CASE column_info-fieldname.
      ...
      WHEN OTHERS.
    ENDCASE.
  ENDMETHOD.                    "on_context_menu_request
...
* Flüge des laufenden Monats hervorheben
...
* register event handlers
  SET HANDLER: lcl_handle=>on_toolbar FOR alv,
               lcl_handle=>on_user_command FOR alv,
               lcl_handle=>print_top FOR alv,
               lcl_handle=>print_tol FOR alv,
               lcl_handle=>on_double_click FOR alv,
               lcl_handle=>on_context_menu_request FOR alv.
...
*fill field catalog
  ...
  wa_field_cat-coltext = 'Auslastung'(h02).
  APPEND wa_field_cat TO it_field_cat.
