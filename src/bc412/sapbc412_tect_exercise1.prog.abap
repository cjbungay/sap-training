*&---------------------------------------------------------------------*
*& Report  SAPBC412_TECT_EXERCISE1                                     *
*&                                                                     *
*&---------------------------------------------------------------------*
*&                                                                     *
*& Copy template for the exercise of unit 'Text Edit Control'          *
*& of classroom training BC412.                                        *
*& The program should display a picture within a picture control.      *
*&---------------------------------------------------------------------*

REPORT  sapbc412_tect_exercise1 MESSAGE-ID bc412.
*---------------------------------------------------------------------*
...
*       5)  create container object for the Text Edit Control
*           and link it to screen area
*       6)  create Text Edit object and link to container
*       7)  suppress display of the Text Edit Control toolbar
*           and the statusline
*       8)  fill text into a table and load the table into
*           Text Edit Control
*----------------------------------------------------------------------*
MODULE init_control_processing OUTPUT.
