*&---------------------------------------------------------------------*
*& Report  SAPBC412_CONT_EXERCISE1                                     *
*&                                                                     *
*&---------------------------------------------------------------------*
*& Copy template for exercise 1 of unit SAP Container.                 *
*& Task: Substitute the custom container object by a docking container *
*&       object.                                                       *
*&                                                                     *
*&---------------------------------------------------------------------*

REPORT  sapbc412_cont_exercise1 MESSAGE-ID bc412.
*---------------------------------------------------------------------*
