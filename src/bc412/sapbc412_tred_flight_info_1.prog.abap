...
*&---------------------------------------------------------------------*
*&                                                                     *
*& BC412: Demo 1 of a flight info tree in combination with several     *
*&        subscreen windows displaying detail data of the node selected*
*&        in the tree.                                                 *
*&        The hosting screen consists of 2 areas:                      *
*&          - on the left side the flight info tree is displayed       *
*&          - on the right side the detail screeen is displayed        *
*&        The flight info tree covers data from tables SCARR, SPFLI,   *
*&        SFLIGHT and SBOOK.                                           *
*&                                                                     *
*&        The flight info tree is implemented via a local class.       *
*&                                                                     *
*&---------------------------------------------------------------------*
...
* includes
INCLUDE bc412_flight_info_tree_1lcl.   " tree handling + application
                                       " data
* Screen fields
...
* object references
        my_flight_tree TYPE REF TO lcl_flight_info_tree_1,
...
CLASS lcl_event_handler DEFINITION.
  PUBLIC SECTION.
    CLASS-METHODS: on_node_double_click
                FOR EVENT node_double_click OF lcl_flight_info_tree_1
                IMPORTING
                  e_carrid
                  e_connid
                  e_fldate
...
CLASS lcl_event_handler IMPLEMENTATION.
  METHOD: on_node_double_click.
    CASE e_level.
      WHEN lcl_flight_info_tree_1=>c_level_1. " SCARR   node
...
*       set corresponding subscreen number
      ...
      WHEN lcl_flight_info_tree_1=>c_level_2. " SPFLI   node
...
*       set corresponding subscreen number
      ...
      WHEN lcl_flight_info_tree_1=>c_level_3. " SFLIGHT node
*       get spfli details (flight_info_tree cashes data)
...
*       set corresponding subscreen number
      ...
      WHEN lcl_flight_info_tree_1=>c_level_4. " SBOOK   node
...
*   create tree_application object
    CREATE OBJECT my_flight_tree
      EXPORTING
        ...
        i_node_double_click = lcl_flight_info_tree_1=>c_true
        i_appl_event_ndc    = lcl_flight_info_tree_1=>c_true
        i_level_no          = lcl_flight_info_tree_1=>c_level_4
      EXCEPTIONS
        others = 1.
    IF sy-subrc NE 0.
