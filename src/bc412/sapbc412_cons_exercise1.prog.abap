*&---------------------------------------------------------------------*
*& Report  SAPBC412_CONS_EXERCISE1                                    *
*&                                                                     *
*&---------------------------------------------------------------------*
*& Model solution for the first exercise of unit SAP CONTAINER         *
*& CONTROLS. Instead of an instance of SAP Custom Container Control    *
*& now an instance of SAP Docking Container Control is used            *
