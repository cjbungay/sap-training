*&---------------------------------------------------------------------*
*& SAPBC412_TRMS_EXERCISE_3_OPT                                        *
*&                                                                     *
*&---------------------------------------------------------------------*
*&                                                                     *
*& Model solution for the optional part of the third exercise of unit  *
*& 'TREE Control' of classroom training BC412.                         *
*&                                                                     *
*& The program displays SCARR, SPFLI and SFLIGHT data and an icon      *
*& using an Column Tree Model.                                         *
*&                                                                     *
*&---------------------------------------------------------------------*

REPORT  sapbc412_trms_exercise_3_opt MESSAGE-ID bc412.
