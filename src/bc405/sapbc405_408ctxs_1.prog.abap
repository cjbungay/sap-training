...
************************************************************************
  METHOD on_user_command.
    DATA:
      ...
      le_text       TYPE string,
      le_row        TYPE sy-tabix,
      le_carrname   TYPE scarr-carrname,
...
*       providing IDs of selected rows
      ...
      WHEN 'CARRIER_INFO'.
        READ TABLE it_sflight INTO wa_sflight INDEX le_row.
        SELECT SINGLE carrname
          FROM scarr
          INTO le_carrname
          WHERE carrid = wa_sflight-carrid.
        MESSAGE le_carrname TYPE 'I'.
