...
MODULE check_sflight INPUT.
  ...
  SELECT COUNT( * )
      FROM  sflight07
      INTO lv_counter
      WHERE carrid      = sflight07-carrid AND
...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight07-price      TO gs_flight-price,
      sflight07-currency   TO gs_flight-currency,
      sflight07-planetype  TO gs_flight-planetype,
      sflight07-seatsmax   TO gs_flight-seatsmax,
      sflight07-seatsocc   TO gs_flight-seatsocc
      .
