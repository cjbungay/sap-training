*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG04TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG04##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_04flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight04,
    gs_flight_hlp   TYPE sflight04
    .
