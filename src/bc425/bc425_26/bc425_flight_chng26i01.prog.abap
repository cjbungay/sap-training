...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      SFLIGHT26-price      TO gs_flight-price,
      SFLIGHT26-currency   TO gs_flight-currency,
      SFLIGHT26-planetype  TO gs_flight-planetype,
      SFLIGHT26-seatsmax   TO gs_flight-seatsmax,
      SFLIGHT26-seatsocc   TO gs_flight-seatsocc
      .
