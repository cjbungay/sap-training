class CL_EX_BADI_BOOK26 definition
  public
  final
  create public .

*"* public components of class CL_EX_BADI_BOOK26
*"* do not include other source files here!!!
public section.

  interfaces IF_EX_BADI_BOOK26 .
  type-pools SEEX .
protected section.
*"* protected components of class CL_EX_BADI_BOOK26
*"* do not include other source files here!!!
private section.
*"* private components of class CL_EX_BADI_BOOK26
*"* do not include other source files here!!!
...
DATA: EXITINTF TYPE REF TO IF_EX_BADI_BOOK26.
  ...
  LOOP AT EXIT_OBJ_TAB INTO EXIT_OBJ.
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'hqd{etuwvKcuO3zsXp1Rtm'
           TYP     = 'UE'.
...
method IF_EX_BADI_BOOK26~OUTPUT.
CLASS CL_EXIT_MASTER DEFINITION LOAD.
DATA: EXIT_OBJ_TAB TYPE SEEX_EXIT_TAB,
      EXIT_OBJ TYPE SEEX_EXIT_TAB_STRUCT.
...
DATA: EXITINTF TYPE REF TO IF_EX_BADI_BOOK26.
  ...
  LOOP AT EXIT_OBJ_TAB INTO EXIT_OBJ.
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'mba1617i64E7lWHYKnJ95W'
           TYP     = 'UE'.
