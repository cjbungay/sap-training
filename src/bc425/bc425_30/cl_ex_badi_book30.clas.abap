class CL_EX_BADI_BOOK30 definition
  public
  final
  create public .

*"* public components of class CL_EX_BADI_BOOK30
*"* do not include other source files here!!!
public section.

  interfaces IF_EX_BADI_BOOK30 .
  type-pools SEEX .
protected section.
*"* protected components of class CL_EX_BADI_BOOK30
*"* do not include other source files here!!!
private section.
*"* private components of class CL_EX_BADI_BOOK30
*"* do not include other source files here!!!
...
DATA: EXITINTF TYPE REF TO IF_EX_BADI_BOOK30.
  ...
  LOOP AT EXIT_OBJ_TAB INTO EXIT_OBJ.
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'CmKyA93IR4kAwk}FRc4bum'
           TYP     = 'UE'.
...
method IF_EX_BADI_BOOK30~OUTPUT.
CLASS CL_EXIT_MASTER DEFINITION LOAD.
DATA: EXIT_OBJ_TAB TYPE SEEX_EXIT_TAB,
      EXIT_OBJ TYPE SEEX_EXIT_TAB_STRUCT.
