*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG30TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG30##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_30flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE SFLIGHT30,
    gs_flight_hlp   TYPE SFLIGHT30
    .
