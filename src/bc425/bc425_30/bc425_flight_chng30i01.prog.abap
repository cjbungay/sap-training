...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      SFLIGHT30-price      TO gs_flight-price,
      SFLIGHT30-currency   TO gs_flight-currency,
      SFLIGHT30-planetype  TO gs_flight-planetype,
      SFLIGHT30-seatsmax   TO gs_flight-seatsmax,
      SFLIGHT30-seatsocc   TO gs_flight-seatsocc
      .
