...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight99-price      TO gs_flight-price,
      sflight99-currency   TO gs_flight-currency,
      sflight99-planetype  TO gs_flight-planetype,
      sflight99-seatsmax   TO gs_flight-seatsmax,
      sflight99-seatsocc   TO gs_flight-seatsocc
      .
