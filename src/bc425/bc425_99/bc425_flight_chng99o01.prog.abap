...
*&---------------------------------------------------------------------*
*     Initialize table sflight99 and field OKCODE                      *
*----------------------------------------------------------------------*
MODULE initialize OUTPUT.
  CLEAR: sflight99,
         gs_flight,
...
module read_sflight output.
  ...
  SELECT SINGLE *
      ...
      WHERE carrid      = sflight99-carrid AND
            connid      = sflight99-connid AND
            fldate      = sflight99-fldate .
...
*&---------------------------------------------------------------------*
*     Enable customer to move sflight99 work area to X-function group  *
*----------------------------------------------------------------------*
MODULE data_for_subscreen OUTPUT.
...
MODULE lock_data OUTPUT.
  ...
  CALL FUNCTION 'ENQUEUE_ESFLIGHT99'
   EXPORTING
     mode_sflight99       = 'E'
     mandt                = sy-mandt
     carrid               = sflight99-carrid
     connid               = sflight99-connid
     fldate               = sflight99-fldate
*   _SCOPE               = '2'
*   _WAIT                = ' '
*   _COLLECT             = ' '
...
MODULE move_data_to_screen OUTPUT.
  ...
  MOVE-CORRESPONDING gs_flight TO sflight99.
