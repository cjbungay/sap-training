*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG12TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG12##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_12flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight12,
    gs_flight_hlp   TYPE sflight12
    .
