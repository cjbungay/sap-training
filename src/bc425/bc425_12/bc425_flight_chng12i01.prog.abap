...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight12-price      TO gs_flight-price,
      sflight12-currency   TO gs_flight-currency,
      sflight12-planetype  TO gs_flight-planetype,
      sflight12-seatsmax   TO gs_flight-seatsmax,
      sflight12-seatsocc   TO gs_flight-seatsocc
      .
