class CL_EX_BADI_BOOK19 definition
  public
  final
  create public .

*"* public components of class CL_EX_BADI_BOOK19
*"* do not include other source files here!!!
public section.

  interfaces IF_EX_BADI_BOOK29 .
  type-pools SEEX .
protected section.
*"* protected components of class CL_EX_BADI_BOOK19
*"* do not include other source files here!!!
private section.
*"* private components of class CL_EX_BADI_BOOK19
*"* do not include other source files here!!!
  ...
  LOOP AT EXIT_OBJ_TAB INTO EXIT_OBJ.
    ...
    CATCH SYSTEM-EXCEPTIONS MOVE_CAST_ERROR = 1.
      ...
      CALL FUNCTION 'PF_ASTAT_OPEN'
         EXPORTING
             OPENKEY = 't7XQLa7nr16hRm3Gjpo6nG'
             TYP     = 'UE'.
...
method IF_EX_BADI_BOOK29~OUTPUT.
CLASS CL_EXIT_MASTER DEFINITION LOAD.
DATA: EXIT_OBJ_TAB TYPE SEEX_EXIT_TAB,
      EXIT_OBJ TYPE SEEX_EXIT_TAB_STRUCT.
...
DATA: EXITINTF TYPE REF TO IF_EX_BADI_BOOK29.
  ...
  LOOP AT EXIT_OBJ_TAB INTO EXIT_OBJ.
    ...
    CATCH SYSTEM-EXCEPTIONS MOVE_CAST_ERROR = 1.
      ...
      CALL FUNCTION 'PF_ASTAT_OPEN'
         EXPORTING
             OPENKEY = 'stXQLa7nr16hRm3Gjpo6nG'
             TYP     = 'UE'.
