...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight19-price      TO gs_flight-price,
      sflight19-currency   TO gs_flight-currency,
      sflight19-planetype  TO gs_flight-planetype,
      sflight19-seatsmax   TO gs_flight-seatsmax,
      sflight19-seatsocc   TO gs_flight-seatsocc
      .
