...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight13-price      TO gs_flight-price,
      sflight13-currency   TO gs_flight-currency,
      sflight13-planetype  TO gs_flight-planetype,
      sflight13-seatsmax   TO gs_flight-seatsmax,
      sflight13-seatsocc   TO gs_flight-seatsocc
      .
