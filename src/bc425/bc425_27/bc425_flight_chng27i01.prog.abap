...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      SFLIGHT27-price      TO gs_flight-price,
      SFLIGHT27-currency   TO gs_flight-currency,
      SFLIGHT27-planetype  TO gs_flight-planetype,
      SFLIGHT27-seatsmax   TO gs_flight-seatsmax,
      SFLIGHT27-seatsocc   TO gs_flight-seatsocc
      .
