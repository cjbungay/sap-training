...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight09-price      TO gs_flight-price,
      sflight09-currency   TO gs_flight-currency,
      sflight09-planetype  TO gs_flight-planetype,
      sflight09-seatsmax   TO gs_flight-seatsmax,
      sflight09-seatsocc   TO gs_flight-seatsocc
      .
