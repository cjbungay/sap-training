...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      SFLIGHT28-price      TO gs_flight-price,
      SFLIGHT28-currency   TO gs_flight-currency,
      SFLIGHT28-planetype  TO gs_flight-planetype,
      SFLIGHT28-seatsmax   TO gs_flight-seatsmax,
      SFLIGHT28-seatsocc   TO gs_flight-seatsocc
      .
