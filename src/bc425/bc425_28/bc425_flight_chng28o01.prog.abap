...
*&---------------------------------------------------------------------*
*     Initialize table SFLIGHT28 and field OKCODE                      *
*----------------------------------------------------------------------*
MODULE initialize OUTPUT.
  CLEAR: SFLIGHT28,
         gs_flight,
...
module read_sflight output.
  ...
  SELECT SINGLE *
      ...
      WHERE carrid      = SFLIGHT28-carrid AND
...
*&---------------------------------------------------------------------*
*     Enable customer to move SFLIGHT28 work area to X-function group  *
*----------------------------------------------------------------------*
MODULE data_for_subscreen OUTPUT.
...
MODULE lock_data OUTPUT.
  ...
  CALL FUNCTION 'ENQUEUE_ESFLIGHT28'
   EXPORTING
     mode_SFLIGHT28       = 'E'
     mandt                = sy-mandt
...
MODULE move_data_to_screen OUTPUT.
  ...
  MOVE-CORRESPONDING gs_flight TO SFLIGHT28.
