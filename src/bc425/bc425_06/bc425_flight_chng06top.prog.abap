*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG06TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG06##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_06flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight06,
    gs_flight_hlp   TYPE sflight06
    .
