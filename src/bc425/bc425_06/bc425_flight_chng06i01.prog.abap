...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight06-price      TO gs_flight-price,
      sflight06-currency   TO gs_flight-currency,
      sflight06-planetype  TO gs_flight-planetype,
      sflight06-seatsmax   TO gs_flight-seatsmax,
      sflight06-seatsocc   TO gs_flight-seatsocc
      .
