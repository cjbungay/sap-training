*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG03TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG03##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_03flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight03,
    gs_flight_hlp   TYPE sflight03
    .
