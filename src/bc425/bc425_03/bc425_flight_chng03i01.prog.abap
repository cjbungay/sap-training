...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight03-price      TO gs_flight-price,
      sflight03-currency   TO gs_flight-currency,
      sflight03-planetype  TO gs_flight-planetype,
      sflight03-seatsmax   TO gs_flight-seatsmax,
      sflight03-seatsocc   TO gs_flight-seatsocc
      .
