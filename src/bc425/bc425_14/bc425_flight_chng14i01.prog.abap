...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight14-price      TO gs_flight-price,
      sflight14-currency   TO gs_flight-currency,
      sflight14-planetype  TO gs_flight-planetype,
      sflight14-seatsmax   TO gs_flight-seatsmax,
      sflight14-seatsocc   TO gs_flight-seatsocc
      .
