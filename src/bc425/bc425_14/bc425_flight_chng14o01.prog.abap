...
*&---------------------------------------------------------------------*
*     Initialize table sflight14 and field OKCODE                      *
*----------------------------------------------------------------------*
MODULE initialize OUTPUT.
  CLEAR: sflight14,
         gs_flight,
...
module read_sflight output.
  ...
  SELECT SINGLE *
      ...
      WHERE carrid      = sflight14-carrid AND
...
*&---------------------------------------------------------------------*
*     Enable customer to move sflight14 work area to X-function group  *
*----------------------------------------------------------------------*
MODULE data_for_subscreen OUTPUT.
...
MODULE lock_data OUTPUT.
  ...
  CALL FUNCTION 'ENQUEUE_ESFLIGHT14'
   EXPORTING
     mode_sflight14       = 'E'
     mandt                = sy-mandt
...
MODULE move_data_to_screen OUTPUT.
  ...
  MOVE-CORRESPONDING gs_flight TO sflight14.
