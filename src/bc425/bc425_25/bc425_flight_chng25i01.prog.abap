...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      SFLIGHT25-price      TO gs_flight-price,
      SFLIGHT25-currency   TO gs_flight-currency,
      SFLIGHT25-planetype  TO gs_flight-planetype,
      SFLIGHT25-seatsmax   TO gs_flight-seatsmax,
      SFLIGHT25-seatsocc   TO gs_flight-seatsocc
      .
