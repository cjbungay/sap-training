*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG25TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG25                            *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_25flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE SFLIGHT25,
    gs_flight_hlp   TYPE SFLIGHT25
    .
