...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight22-price      TO gs_flight-price,
      sflight22-currency   TO gs_flight-currency,
      sflight22-planetype  TO gs_flight-planetype,
      sflight22-seatsmax   TO gs_flight-seatsmax,
      sflight22-seatsocc   TO gs_flight-seatsocc
      .
