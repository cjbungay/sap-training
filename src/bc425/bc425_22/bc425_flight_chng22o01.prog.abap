...
*&---------------------------------------------------------------------*
*     Initialize table sflight22 and field OKCODE                      *
*----------------------------------------------------------------------*
MODULE initialize OUTPUT.
  CLEAR: sflight22,
         gs_flight,
...
module read_sflight output.
  ...
  SELECT SINGLE *
      ...
      WHERE carrid      = sflight22-carrid AND
...
*&---------------------------------------------------------------------*
*     Enable customer to move sflight22 work area to X-function group  *
*----------------------------------------------------------------------*
MODULE data_for_subscreen OUTPUT.
...
MODULE lock_data OUTPUT.
  ...
  CALL FUNCTION 'ENQUEUE_ESFLIGHT22'
   EXPORTING
     mode_sflight22       = 'E'
     mandt                = sy-mandt
...
MODULE move_data_to_screen OUTPUT.
  ...
  MOVE-CORRESPONDING gs_flight TO sflight22.
