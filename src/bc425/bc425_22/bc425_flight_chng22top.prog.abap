*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG22TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG22                            *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_22flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight22,
    gs_flight_hlp   TYPE sflight22
    .
