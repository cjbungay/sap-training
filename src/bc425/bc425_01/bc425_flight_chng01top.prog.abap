*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG01TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG01##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_01flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight01,
    gs_flight_hlp   TYPE sflight01
    .
