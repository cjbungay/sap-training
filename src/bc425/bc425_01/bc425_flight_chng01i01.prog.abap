...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight01-price      TO gs_flight-price,
      sflight01-currency   TO gs_flight-currency,
      sflight01-planetype  TO gs_flight-planetype,
      sflight01-seatsmax   TO gs_flight-seatsmax,
      sflight01-seatsocc   TO gs_flight-seatsocc
      .
