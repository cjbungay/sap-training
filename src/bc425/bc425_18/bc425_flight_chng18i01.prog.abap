...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight18-price      TO gs_flight-price,
      sflight18-currency   TO gs_flight-currency,
      sflight18-planetype  TO gs_flight-planetype,
      sflight18-seatsmax   TO gs_flight-seatsmax,
      sflight18-seatsocc   TO gs_flight-seatsocc
      .
