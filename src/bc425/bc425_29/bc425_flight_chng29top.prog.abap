*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG29TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG29##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_29flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE SFLIGHT29,
    gs_flight_hlp   TYPE SFLIGHT29
    .
