...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      SFLIGHT29-price      TO gs_flight-price,
      SFLIGHT29-currency   TO gs_flight-currency,
      SFLIGHT29-planetype  TO gs_flight-planetype,
      SFLIGHT29-seatsmax   TO gs_flight-seatsmax,
      SFLIGHT29-seatsocc   TO gs_flight-seatsocc
      .
