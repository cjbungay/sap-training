class CL_EX_BADI_BOOK29 definition
  public
  final
  create public .

*"* public components of class CL_EX_BADI_BOOK29
...
public section.
  ...
  type-pools SEEX .
protected section.
*"* protected components of class CL_EX_BADI_BOOK29
*"* do not include other source files here!!!
private section.
*"* private components of class CL_EX_BADI_BOOK29
*"* do not include other source files here!!!
...
CLASS CL_EX_BADI_BOOK29 IMPLEMENTATION.
...
DATA: EXITINTF TYPE REF TO IF_EX_BADI_BOOK29.
  ...
  LOOP AT EXIT_OBJ_TAB INTO EXIT_OBJ.
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'qEBAW63krKkuQATi3h5Cmm'
           TYP     = 'UE'.
