...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight08-price      TO gs_flight-price,
      sflight08-currency   TO gs_flight-currency,
      sflight08-planetype  TO gs_flight-planetype,
      sflight08-seatsmax   TO gs_flight-seatsmax,
      sflight08-seatsocc   TO gs_flight-seatsocc
      .
