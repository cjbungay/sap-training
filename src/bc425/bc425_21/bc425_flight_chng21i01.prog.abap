...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      SFLIGHT21-price      TO gs_flight-price,
      SFLIGHT21-currency   TO gs_flight-currency,
      SFLIGHT21-planetype  TO gs_flight-planetype,
      SFLIGHT21-seatsmax   TO gs_flight-seatsmax,
      SFLIGHT21-seatsocc   TO gs_flight-seatsocc
      .
