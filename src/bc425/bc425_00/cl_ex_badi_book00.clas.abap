...
class CL_EX_BADI_BOOK00 definition
  public
  final
  create public .

*" public components of class CL_EX_BADI_BOOK00
...
interfaces:
  IF_EX_BADI_BOOK00 .
protected section.
*" protected components of class CL_EX_BADI_BOOK00
*" do not include other source files here!!!

private section.
*" private components of class CL_EX_BADI_BOOK00
*" do not include other source files here!!!
...
CLASS CL_EX_BADI_BOOK00 IMPLEMENTATION.
...
method IF_EX_BADI_BOOK00~CHANGE_VLINE.
  ...
  data exitintf type ref to IF_EX_BADI_BOOK00 .

  loop at EXIT_TABLE INTO EXIT_OBJ WHERE
          inter_name   = 'IF_EX_BADI_BOOK00' and
          FLT_VAL      = SPACE.
  ...
  loop at EXIT_OBJ_TAB into EXIT_OBJ.
    ...
    check EXIT_OBJ-ACTIVE = SEEX_TRUE.
      ...
      call function 'PF_ASTAT_OPEN'
        exporting
           OPENKEY = 'hSd{wYI2qn6AEm2WoSWnTW'
           TYP     = 'UE'.
...
method IF_EX_BADI_BOOK00~OUTPUT.
  ...
  loop at EXIT_OBJ_TAB into EXIT_OBJ.
    ...
    check EXIT_OBJ-ACTIVE = SEEX_TRUE.
      ...
      call function 'PF_ASTAT_OPEN'
        exporting
           OPENKEY = 'hCd{wYI2qn6AEm2WoSWnTW'
           TYP     = 'UE'.
