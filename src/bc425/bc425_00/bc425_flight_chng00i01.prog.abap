...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight00-price      TO gs_flight-price,
      sflight00-currency   TO gs_flight-currency,
      sflight00-planetype  TO gs_flight-planetype,
      sflight00-seatsmax   TO gs_flight-seatsmax,
      sflight00-seatsocc   TO gs_flight-seatsocc
      .
