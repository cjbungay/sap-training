*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG00TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG00##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_00flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight00,
    gs_flight_hlp   TYPE sflight00
    .
