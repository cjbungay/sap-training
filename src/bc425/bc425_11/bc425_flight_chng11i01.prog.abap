...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight11-price      TO gs_flight-price,
      sflight11-currency   TO gs_flight-currency,
      sflight11-planetype  TO gs_flight-planetype,
      sflight11-seatsmax   TO gs_flight-seatsmax,
      sflight11-seatsocc   TO gs_flight-seatsocc
      .
