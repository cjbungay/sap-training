*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG11TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG11##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_11flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight11,
    gs_flight_hlp   TYPE sflight11
    .
