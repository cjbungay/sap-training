...
*&---------------------------------------------------------------------*
*     Initialize table sflight11 and field OKCODE                      *
*----------------------------------------------------------------------*
MODULE initialize OUTPUT.
  CLEAR: sflight11,
         gs_flight,
...
module read_sflight output.
  ...
  SELECT SINGLE *
      ...
      WHERE carrid      = sflight11-carrid AND
...
*&---------------------------------------------------------------------*
*     Enable customer to move sflight11 work area to X-function group  *
*----------------------------------------------------------------------*
MODULE data_for_subscreen OUTPUT.
...
MODULE lock_data OUTPUT.
  ...
  CALL FUNCTION 'ENQUEUE_ESFLIGHT11'
   EXPORTING
     mode_sflight11       = 'E'
     mandt                = sy-mandt
...
MODULE move_data_to_screen OUTPUT.
  ...
  MOVE-CORRESPONDING gs_flight TO sflight11.
