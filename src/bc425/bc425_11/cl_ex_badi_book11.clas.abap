...
class CL_EX_BADI_BOOK11 definition
  public
  final
  create public .

*" public components of class CL_EX_BADI_BOOK11
...
interfaces:
  IF_EX_BADI_BOOK11 .
protected section.
*" protected components of class CL_EX_BADI_BOOK11
*" do not include other source files here!!!

private section.
*" private components of class CL_EX_BADI_BOOK11
*" do not include other source files here!!!
...
CLASS CL_EX_BADI_BOOK11 IMPLEMENTATION.
...
method IF_EX_BADI_BOOK11~CHANGE_VLINE.
  ...
  data exitintf type ref to IF_EX_BADI_BOOK11 .

  loop at EXIT_TABLE INTO EXIT_OBJ WHERE
          inter_name   = 'IF_EX_BADI_BOOK11' and
          FLT_VAL      = SPACE.
  ...
  loop at EXIT_OBJ_TAB into EXIT_OBJ.
    ...
    check EXIT_OBJ-ACTIVE = SEEX_TRUE.
      ...
      call function 'PF_ASTAT_OPEN'
        exporting
           OPENKEY = 'Yih{wYI2qn6AEm2WoSWnTW'
           TYP     = 'UE'.
...
method IF_EX_BADI_BOOK11~OUTPUT.
  ...
  loop at EXIT_OBJ_TAB into EXIT_OBJ.
    ...
    check EXIT_OBJ-ACTIVE = SEEX_TRUE.
      ...
      call function 'PF_ASTAT_OPEN'
        exporting
           OPENKEY = 'YSh{wYI2qn6AEm2WoSWnTW'
           TYP     = 'UE'.
