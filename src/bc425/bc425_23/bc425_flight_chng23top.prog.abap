*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG23TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG23                            *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_23flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE SFLIGHT23,
    gs_flight_hlp   TYPE SFLIGHT23
    .
