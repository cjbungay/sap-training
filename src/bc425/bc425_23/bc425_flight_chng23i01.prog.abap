...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      SFLIGHT23-price      TO gs_flight-price,
      SFLIGHT23-currency   TO gs_flight-currency,
      SFLIGHT23-planetype  TO gs_flight-planetype,
      SFLIGHT23-seatsmax   TO gs_flight-seatsmax,
      SFLIGHT23-seatsocc   TO gs_flight-seatsocc
      .
