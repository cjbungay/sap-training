...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight16-price      TO gs_flight-price,
      sflight16-currency   TO gs_flight-currency,
      sflight16-planetype  TO gs_flight-planetype,
      sflight16-seatsmax   TO gs_flight-seatsmax,
      sflight16-seatsocc   TO gs_flight-seatsocc
      .
