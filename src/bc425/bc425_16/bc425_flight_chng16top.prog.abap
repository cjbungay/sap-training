*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG16TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG16##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_16flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight16,
    gs_flight_hlp   TYPE sflight16
    .
