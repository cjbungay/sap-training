*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG24TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG24                            *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_24flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE SFLIGHT24,
    gs_flight_hlp   TYPE SFLIGHT24
    .
