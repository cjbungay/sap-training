...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      SFLIGHT24-price      TO gs_flight-price,
      SFLIGHT24-currency   TO gs_flight-currency,
      SFLIGHT24-planetype  TO gs_flight-planetype,
      SFLIGHT24-seatsmax   TO gs_flight-seatsmax,
      SFLIGHT24-seatsocc   TO gs_flight-seatsocc
      .
