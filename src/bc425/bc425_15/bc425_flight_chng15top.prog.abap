*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG15TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG15##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_15flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight15,
    gs_flight_hlp   TYPE sflight15
    .
