*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG05TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG05##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_05flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight05,
    gs_flight_hlp   TYPE sflight05
    .
