...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight05-price      TO gs_flight-price,
      sflight05-currency   TO gs_flight-currency,
      sflight05-planetype  TO gs_flight-planetype,
      sflight05-seatsmax   TO gs_flight-seatsmax,
      sflight05-seatsocc   TO gs_flight-seatsocc
      .
