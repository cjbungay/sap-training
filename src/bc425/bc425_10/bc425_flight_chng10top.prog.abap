*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG10TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG10##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_10flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight10,
    gs_flight_hlp   TYPE sflight10
    .
