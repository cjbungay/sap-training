...
*&---------------------------------------------------------------------*
*     Initialize table sflight20 and field OKCODE                      *
*----------------------------------------------------------------------*
MODULE initialize OUTPUT.
  CLEAR: sflight20,
         gs_flight,
...
module read_sflight output.
  ...
  SELECT SINGLE *
      ...
      WHERE carrid      = sflight20-carrid AND
...
*&---------------------------------------------------------------------*
*     Enable customer to move sflight20 work area to X-function group  *
*----------------------------------------------------------------------*
MODULE data_for_subscreen OUTPUT.
...
MODULE lock_data OUTPUT.
  ...
  CALL FUNCTION 'ENQUEUE_ESFLIGHT20'
   EXPORTING
     mode_sflight20       = 'E'
     mandt                = sy-mandt
...
MODULE move_data_to_screen OUTPUT.
  ...
  MOVE-CORRESPONDING gs_flight TO sflight20.
