...
MODULE move_data_from_screen INPUT.
  ...
  MOVE:
      sflight20-price      TO gs_flight-price,
      sflight20-currency   TO gs_flight-currency,
      sflight20-planetype  TO gs_flight-planetype,
      sflight20-seatsmax   TO gs_flight-seatsmax,
      sflight20-seatsocc   TO gs_flight-seatsocc
      .
