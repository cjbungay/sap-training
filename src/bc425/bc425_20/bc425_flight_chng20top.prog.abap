*&---------------------------------------------------------------------*
*& Include          BC425_FLIGHT_CHNG20TOP                             *
*& Modulpool        SAPBC425D_FLIGHT_CHNG20##                          *
*&                                                                     *
*&---------------------------------------------------------------------*
...
DATA:
    ...
    gr_badi_reference  TYPE REF TO if_ex_bc425_20flight2,
...
* Table of Function codes to be excluded (and work area)
    ...
    gs_flight       TYPE sflight20,
    gs_flight_hlp   TYPE sflight20
    .
