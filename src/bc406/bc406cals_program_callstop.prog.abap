*----------------------------------------------------------------------*
*   INCLUDE      SAPBC406cals_programs_calls                        *
*----------------------------------------------------------------------*
PROGRAM sapbc406cals_programs_calls MESSAGE-ID bc406.
...
* table of connids for calling list program
RANGES  connids FOR wa_flight-connid.

* number of entries in internal table connids
