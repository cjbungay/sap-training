...
************************************************************************
* Change to asynchrounous update technique
************************************************************************
...
MODULE user_command_0300 INPUT.
  ...
  CASE save_ok.
    ...
    WHEN 'SAVE'.
************************************************************************
* realize DB changes (SBOOK and SFLIGHT) using asynchronous update
* technique. Changes are encapsulated in FORM SAVE_NEW_BOOKING.
************************************************************************
