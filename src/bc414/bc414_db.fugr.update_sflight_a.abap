...
DATA: NUMBER TYPE SFLIGHT-SEATSOCC, PAYMENTSUM TYPE SFLIGHT-PAYMENTSUM.
...
* Numer of bookings smaller than or equal seats in plane
        UPDATE SFLIGHT SET SEATSOCC   = NUMBER
               ...
               AND   FLDATE = DATE.
        IF SY-SUBRC <> 0.
          MESSAGE A044 RAISING UPDATE_FAILURE.
        ELSE.
          MESSAGE I033 WITH CARRIER CONNECTION DATE.
        ENDIF.
* Numer of bookings larger than seats in plane
    ...
    WHEN OTHERS.                       "Flight does not exist
      MESSAGE A023 RAISING FLIGHT_NOT_FOUND.
  ENDCASE.
