...
PROGRAM  sapbc414t_bookings_06 MESSAGE-ID bc414.

************************************************************************
* Add include (generated by the change document object BC_BOOK), which
* contains the data definitions neccessary for the creation of change
* documents
************************************************************************
