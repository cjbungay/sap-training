class CL_EX_BC_TAW12_CS definition
  public
  final
  create public .

*"* public components of class CL_EX_BC_TAW12_CS
...
public section.
  ...
  class-data DYNPRO_INSTANCE type ref to IF_EX_BC_TAW12_CS read-only .

  class-methods GET_INSTANCE_FOR_SUBSCREEN
    returning
      value(INSTANCE) type ref to IF_EX_BC_TAW12_CS .
  class-methods SET_INSTANCE_FOR_SUBSCREEN
    importing
      value(INSTANCE) type ref to IF_EX_BC_TAW12_CS .
  type-pools SXRT .
protected section.
*"* protected components of class CL_EX_BC_TAW12_CS
*"* do not include other source files here!!!
private section.
*"* private components of class CL_EX_BC_TAW12_CS
*"* do not include other source files here!!!
...
CLASS CL_EX_BC_TAW12_CS IMPLEMENTATION.


method GET_INSTANCE_FOR_SUBSCREEN .
  instance = CL_EX_BC_TAW12_CS=>DYNPRO_INSTANCE.
endmethod.
...
method IF_EX_BC_TAW12_CS~GET_KEY_DATA .
  ...
  DATA: exitintf TYPE REF TO IF_EX_BC_TAW12_CS,
  ...
  IF sy-subrc NE 0.
    LOOP AT INSTANCE_BADI_TABLE ASSIGNING <exit_obj>
         WHERE INTER_NAME   = 'IF_EX_BC_TAW12_CS'
  ...
  LOOP AT INSTANCE_FLT_CACHE ASSIGNING <flt_cache_line>
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'H}xuFQIiC37X00002X569m'
           TYP     = 'UE'.
        ...
        IF <flt_cache_line>-eo_object is initial.
          CALL METHOD ('CL_FOBU_METHOD_EVALUATION')=>load
               EXPORTING
                  ...
                  im_interface_name = 'IF_EX_BC_TAW12_CS'
...
method IF_EX_BC_TAW12_CS~GET_MODUS .
  ...
  LOOP AT INSTANCE_FLT_CACHE ASSIGNING <flt_cache_line>
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'N}xuFQIiC37X00002X569m'
           TYP     = 'UE'.
...
method IF_EX_BC_TAW12_CS~GET_TAB_NAME .
  ...
  LOOP AT INSTANCE_FLT_CACHE ASSIGNING <flt_cache_line>
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'JVxuFQIiC37X00002X569m'
           TYP     = 'UE'.
...
method IF_EX_BC_TAW12_CS~PROCESS_FCODE .
  ...
  LOOP AT INSTANCE_FLT_CACHE ASSIGNING <flt_cache_line>
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'K}xuFQIiC37X00002X569m'
           TYP     = 'UE'.
...
method IF_EX_BC_TAW12_CS~PUT_KEY_DATA .
  ...
  LOOP AT INSTANCE_FLT_CACHE ASSIGNING <flt_cache_line>
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'GVxuFQIiC37X00002X569m'
           TYP     = 'UE'.
...
method IF_EX_BC_TAW12_CS~PUT_MODUS .
  ...
  LOOP AT INSTANCE_FLT_CACHE ASSIGNING <flt_cache_line>
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'E}xuFQIiC37X00002X569m'
           TYP     = 'UE'.
...
method IF_EX_BC_TAW12_CS~SAVE .
  ...
  LOOP AT INSTANCE_FLT_CACHE ASSIGNING <flt_cache_line>
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'MVxuFQIiC37X00002X569m'
           TYP     = 'UE'.
...
CL_EX_BC_TAW12_CS=>DYNPRO_INSTANCE = instance.
endmethod.
ENDCLASS.
