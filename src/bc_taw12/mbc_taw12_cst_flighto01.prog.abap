*----------------------------------------------------------------------*
***INCLUDE MBC410TABS_TABLE_CONTROL3O01
*----------------------------------------------------------------------*
*&---------------------------------------------------------------------*
...
MODULE status_0100 OUTPUT.
  ...
  CASE 'X'.
    WHEN mode-view.
      SET TITLEBAR 'TITLE_100' WITH 'Display'(ti1).
    WHEN mode-maintain_flights.
      SET TITLEBAR 'TITLE_100' WITH 'Maintain Flights'(ti2).
    WHEN mode-maintain_bookings.
      SET TITLEBAR 'TITLE_100' WITH 'Maintain Bookings'(ti3).
  ENDCASE.
